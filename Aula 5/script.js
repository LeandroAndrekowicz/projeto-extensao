...
const seedButtons = document.querySelector(".seed");
...
seedButtons.forEach(button => {
    ...
    messageElement.textContent = `${seed[selectedSeed].name} selecionada. clique em um terreno.`
})
...
function sellAll() {
    ...
    for (const seedName in Inventory) {
        ...
        total += inventory[seedName] * seeds[seedName].seedPrice;
